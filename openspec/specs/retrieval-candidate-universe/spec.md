# retrieval-candidate-universe Specification

## Purpose
TBD - created by archiving change add-neural-text-baseline-and-candidate-universe. Update Purpose after archive.
## Requirements
