...
## Purpose
Define the bounded deterministic local visual-smoke baseline used to exercise
page-image loading, late-interaction-style ranking, and diagnostic report
generation before any real visual-model inference, training, hard-negative
mining, final-test evaluation, or benchmark claim is introduced.
## Requirements
