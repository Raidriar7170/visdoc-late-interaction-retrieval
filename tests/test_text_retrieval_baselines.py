...
def test_dense_text_baseline_is_local_deterministic_and_tie_stable() -> None:
    pages = (
    ...
    retriever = DenseTextRetriever(pages)
...
def test_hybrid_rrf_combines_rankings_and_breaks_ties_by_page_id() -> None:
    pages = (
    ...
    ranking = HybridRetriever(
        ...
        dense_rankings={"query": ("page-b", "page-a", "page-c")},
    ).rank("query")
